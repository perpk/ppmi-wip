...
PATH: Final = "/Users/kpax/Documents/aep/study/MSC/lab/PPMI_Project_133_RNASeq/data/ml/classification/LR/deg_classification/"
...
def main():
    ...
    for gender in genders:
        for age_group in age_groups:
            ...
            result = train_logistic_regression(ppmi_ad_subset, f"{gender}_{age_group}")
            if result is None:
                print(f"Failed to train logistic regression for {age_group} - skipping")
                continue
