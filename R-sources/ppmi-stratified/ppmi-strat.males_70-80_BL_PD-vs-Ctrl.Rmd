...
## Males aged 70-80, cohorts PD vs. Control
...
counts <- read.csv("/Users/kpax/Documents/aep/study/MSC/lab/PPMI_Project_133_RNASeq/counts.csv", row.names=1)
metadata <- read.csv("/Users/kpax/Documents/aep/study/MSC/lab/PPMI_Project_133_RNASeq/metadata.csv", row.names=1)
```
...
write.csv(res_sorted, "/Users/kpax/Documents/aep/study/MSC/lab/PPMI_Project_133_RNASeq/dge_stratified/ppmi-deg_males_70-80_BL_PD-vs-Ctrl.csv")
```
...
ggplot(res_df, aes(x = log2FoldChange, y = -log10(padj))) +
  ...
  labs(
    ...
    title = "PD vs Control - Males, Baseline Visit, ages 70-80"
  ) +
