...
## Males aged 30-50, cohorts PD vs. Control

-   [Link To www.ebi.ac.uk](https://www.ebi.ac.uk/gxa/genes/ENSG00000280800?bs=%7B%22homo%20sapiens%22%3A%5B%22ORGANISM_PART%22%2C%22CELL_LINE%22%2C%22CELL_TYPE%22%2C%22DISEASE%22%2C%22INDIVIDUAL%22%5D%7D&ds=%7B%22kingdom%22%3A%5B%22animals%22%5D%7D#baseline)
- 
...
write.csv(res_sorted, "/Users/kpax/Documents/aep/study/MSC/lab/PPMI_Project_133_RNASeq/dge_stratified/ppmi-deg_males_30-50_BL_PD-vs-Ctrl.csv")
```
...
ggplot(res_df, aes(x = log2FoldChange, y = -log10(padj))) +
  ...
  labs(
    ...
    title = "PD vs Control - Males, Baseline Visit, ages 30-50"
  ) +
